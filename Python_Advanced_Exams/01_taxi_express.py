"""You have created your own taxi company called "Taxi Express". You want to analyze how well your taxi drivers are
doing by calculating how much time they need to tend the customers.
...
customer to his/her destination (the value of the current customer) to the total time. Remove both the customer and the
taxi.
